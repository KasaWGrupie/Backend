...
public class GetMoneyTransfersForRecipientCommandValidator : AbstractValidator<GetMoneyTransferForRecipientCommand>
{
    public GetMoneyTransfersForRecipientCommandValidator()
    {
